...
PYBIND11_MODULE(_mx5, m) {
    ...
    py::class_<ActUtlType>(m, "ActUtlType")
        ...
        .def("SetCpuStatus", &ActUtlType::SetCpuStatus)
        ...
        .def("SetClockData", &ActUtlType::SetClockData)
        .def("SetDevice", &ActUtlType::SetDevice)
        .def("GetDevice", &ActUtlType::GetDevice)
        .def("GetDevice2", &ActUtlType::GetDevice2)
        .def("SetDevice2", &ActUtlType::SetDevice2)
        ...
        .def("set_cpu_status", &ActUtlType::SetCpuStatus)
        ...
        .def("set_clock_data", &ActUtlType::SetClockData)
        .def("set_device", &ActUtlType::SetDevice)
        .def("get_device", &ActUtlType::GetDevice)
        .def("get_device2", &ActUtlType::GetDevice2)
        .def("set_device2", &ActUtlType::SetDevice2);
    ...
    py::class_<ActProgType>(m, "ActProgType")
        ...
        .def("SetCpuStatus", &ActProgType::SetCpuStatus)
        ...
        .def("SetClockData", &ActProgType::SetClockData)
        .def("SetDevice", &ActProgType::SetDevice)
        .def("GetDevice", &ActProgType::GetDevice)
        .def("GetDevice2", &ActProgType::GetDevice2)
        .def("SetDevice2", &ActProgType::SetDevice2)
        ...
        .def("set_cpu_status", &ActProgType::SetCpuStatus)
        ...
        .def("set_clock_data", &ActProgType::SetClockData)
        .def("set_device", &ActProgType::SetDevice)
        .def("get_device", &ActProgType::GetDevice)
        .def("get_device2", &ActProgType::GetDevice2)
        .def("set_device2", &ActProgType::SetDevice2);
}
